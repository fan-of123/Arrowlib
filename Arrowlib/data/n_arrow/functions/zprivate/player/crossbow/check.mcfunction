...
execute if predicate n_arrow:cbowmainhand run scoreboard players set #holdingSlot n_arrow.temp 1
...
scoreboard players set @s n_arrow.cbow_offhand 0
execute if score #holdingSlot n_arrow.temp matches 2 run scoreboard players set @s n_arrow.cbow_offhand 1
